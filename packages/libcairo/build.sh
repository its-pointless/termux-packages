...
TERMUX_PKG_EXTRA_CONFIGURE_ARGS="ac_cv_lib_lzo2_lzo2a_decompress=no --disable-gtk-doc-html --enable-xlib=yes --disable-glesv2 --disable-egl --disable-gl --enable-xlib-xrender --enable-xcb"
