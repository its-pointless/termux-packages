...
TERMUX_PKG_SRCURL=https://www.libssh2.org/snapshots/libssh2-1.8.1-20180128.tar.gz
...
TERMUX_PKG_SHA256=01d7355d5fc6e1fa67606d4b494df4d9f7b58164fbdd45956f146f714d75e4d6

TERMUX_PKG_MAINTAINER="Vishal Biswas @vishalbiswas"
TERMUX_PKG_DEPENDS="openssl"
TERMUX_PKG_EXTRA_CONFIGURE_ARGS="--with-openssl --enable-static"
